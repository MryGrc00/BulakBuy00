    ...
    $redirect = [
        "success" => "http://192.168.1.167/Payments/Payments/success.php?selected_products=" . urlencode(json_encode($selectedProducts)),
        "failed" => "http://192.168.1.167/Payments/Payments/failed.php"
    ];
