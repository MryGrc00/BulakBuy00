    ...
    $redirect = [
        "success" => "http://172.20.10.3:80/Bulakbuy00/Payments/Payments/success.php?selected_products=" . urlencode(json_encode($selectedProducts)),
        "failed" => "http://172.20.10.3:80/Bulakbuy00/Payments/Payments/failed.php"
    ];
