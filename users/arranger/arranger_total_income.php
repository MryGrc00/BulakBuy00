            ...
            <form action="product_pdf.php" method="post">
                <input type="hidden" name="user_id" value="<?php echo $userId; ?>">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="month"  style="width:95%;margin:auto;margin-top:10px" name="month">
                            <?php
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="year"  style="width:95%;margin:auto;margin-top:10px"name="year">
                            <?php
